...
client.on("guildMemberAdd", async member => {
  ...
  require("moment-duration-format");
    ...
    var kontrol;
if (kurulus < 1296000000) kontrol = '**Şüpheli <a:elecus_abno:795770153237217300>**'
if (kurulus > 1296000000) kontrol = '**Güvenli <a:elecus_abyes:795770170445398046>**'
  moment.locale("tr");
  const embed = new Discord.MessageEmbed()
    .setTitle(`ElecusBot | Kayıt Sistemi`)
    .setDescription(`<a:elecus_prizma:798488998061408296> ${member} **Sunucusuna Hoş Geldin!**
  \n<a:elecus_yesil:796020184774082580> **Seninle Birlikte** \`${member.guild.memberCount}\` **Kişiyiz!**
  \n<a:elecus_space:795770206936629278> **Kayıt Olmak İçin Ses Kanallarına Girebilirsin.**
  \n<a:elecus_kitap:798488992961003540> <@&${yetkilirole}> **Rolündeki Seninle İlgilenecektir.**
  \n<a:elecus_kilit:798489000754675732> **Hesap Durumu** ${moment(member.user.createdAt).format("**DD MMMM YYYY dddd (hhss)**") } ${kontrol}`)
    .setImage(`https://cdn.discordapp.com/attachments/779335055893463121/798302310777618490/Q1NDZA.gif`)
  client.channels.cache.get(kanal).send(`<@&${yetkilirole}> ${member}`)
